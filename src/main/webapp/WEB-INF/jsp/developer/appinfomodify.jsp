          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            	<input id="statusName" type="text" class="form-control col-md-7 col-xs-12" 
              	name="statusName" value="<c:forEach items="${statusList}" var="statusList"><c:if test="${statusList.valueId==appInfo.status }">${statusList.valueName }</c:if></c:forEach>" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
